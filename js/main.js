var onLoadWindow = function () {
  if (document.readyState === "complete") {
    ...
    const animItemsWrapFooter = document.querySelectorAll(
      ".anim-items-wrap-footer",
    );
    ...
    if (animItems.length > 0 && animItemsWrap.length > 0) {
      ...
      function animOnScroll() {
        ...
        for (
          let indexWrapFooter = 0;
          indexWrapFooter < animItemsWrapFooter.length;
          indexWrapFooter++
        ) {
          for (
            let indexFooter = 0;
            indexFooter < animItemsFooter.length;
            indexFooter++
          ) {
